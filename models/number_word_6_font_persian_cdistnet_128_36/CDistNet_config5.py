...
attention_dropout_rate = 0.10  # افزایش از 0.05 به 0.10
residual_dropout_rate = 0.20   # افزایش از 0.15 به 0.20
...
train = dict(
    ...
    device='cuda',
    gt_file=['dataset/big_lmdb','dataset/numbers_lmdb'], 
    num_worker=0,
    model_dir='models/number_word_6_font_persian_cdistnet_128_36', 
    num_epochs=31, 
    batch_size=160, 
    model='models/6_font_tps_persian_cdistnet_128_36/epoch2_best_acc.pth',
    current_epoch = 2,
    save_iter=2000,
    display_iter=100,
    tfboard_iter=100, 
...
val = dict(
    ...
    num_worker=0,
    batch_size=160, # اندازه batch برای اعتبارسنجی
)
